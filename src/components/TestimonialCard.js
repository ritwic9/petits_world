  ...
  return (
    <div className="slider-container m-2">
      <Slider {...settings}>
        {/* Testimonial 1 */}
        <div>
          <div className="p-2 bg-primary rounded-tr-3xl rounded-bl-3xl h-14 shadow-lg m-1">
            <div className="flex">
        ...
        <div>
          <div className="p-2 bg-primary rounded-tr-3xl rounded-bl-3xl h-14 shadow-lg m-1">
            ...
            <div className="my-2">
              <p className="font-medium text-xs">
                “Thank you so much Petits World for giving unconditional love
                and care for my son. Despite of so many kids in school, you all
                give personal attention to every child. You are the best in
                Pre-school here.”
              </p>
            </div>
          </div>
          ...
          <div className="p-2 bg-primary rounded-tr-3xl rounded-bl-3xl h-14 shadow-lg m-1">
            ...
            <div className="my-2">
              <p className="font-medium text-xs">
                ...
                things you have thought her. She is all ready for next part of
                her life.”
              </p>
            </div>
          </div>
          ...
          <div className="p-2 bg-primary rounded-tr-3xl rounded-bl-3xl h-14 shadow-lg m-1">
            ...
            <div className="my-2">
              <p className="font-medium text-xs">
                ...
                part of your school. You have provided her a solid foundation
                for her future.”
              </p>
            </div>
          </div>
